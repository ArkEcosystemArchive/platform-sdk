...
export interface ITransactionService {
    ...
    signDelegateRegistration(input: Contracts.DelegateRegistrationInput, options: Contracts.TransactionOptions): Promise<string>;
    ...
    signDelegateResignation(input: Contracts.DelegateResignationInput, options: Contracts.TransactionOptions): Promise<string>;
