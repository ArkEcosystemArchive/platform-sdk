...
export class ProfileValidator implements IProfileValidator {
	...
	public validate(data: IProfileData): IProfileData {
		const { error, value } = Joi.object({
			...
			settings: Joi.object({
				[ProfileSetting.AdvancedMode]: Joi.boolean().default(false),
				...
				[ProfileSetting.DashboardConfiguration]: Joi.boolean().default(false),
				[ProfileSetting.DashboardTransactionHistory]: Joi.boolean().default(false),
				[ProfileSetting.DoNotShowFeeWarning]: Joi.boolean().default(false),
				[ProfileSetting.ErrorReporting]: Joi.boolean().default(false),
