...
let PublicKeyService = class PublicKeyService extends platform_sdk_1.Services.AbstractPublicKeyService {
	constructor() {
		...
		_PublicKeyService_slip44.set(this, void 0);
	}
	onPostConstruct() {
		__classPrivateFieldSet(
			this,
			_PublicKeyService_slip44,
				...
				.derivePublicKey(
					helpers_1.derivePrivateKey(
						...
						_b === void 0
							? void 0
							: _b.addressIndex) || 0,
						__classPrivateFieldGet(this, _PublicKeyService_slip44, "f"),
					),
				)
				.toString("hex"),
		};
...
_PublicKeyService_slip44 = new WeakMap();
__decorate(
	[
