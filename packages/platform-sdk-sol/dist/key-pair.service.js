...
let KeyPairService = class KeyPairService extends platform_sdk_1.Services.AbstractKeyPairService {
	constructor() {
		...
		_KeyPairService_slip44.set(this, void 0);
	}
	onPostConstruct() {
		__classPrivateFieldSet(
			this,
			_KeyPairService_slip44,
	...
	async fromMnemonic(mnemonic, options) {
		...
		const privateBuffer = helpers_1.derivePrivateKey(
			mnemonic,
			...
			((_b = options === null || options === void 0 ? void 0 : options.bip44) === null || _b === void 0
				? void 0
				: _b.addressIndex) || 0,
			__classPrivateFieldGet(this, _KeyPairService_slip44, "f"),
		);
		return {
			publicKey: helpers_1.derivePublicKey(privateBuffer).toString("hex"),
...
_KeyPairService_slip44 = new WeakMap();
__decorate(
	[
