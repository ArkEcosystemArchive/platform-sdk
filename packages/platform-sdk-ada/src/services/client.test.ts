...
describe("ClientService", function () {
	it("#wallet should succeed", async () => {
		...
		const result = await subject.wallet("aec30330deaecdd7503195a0d730256faef87027022b1bdda7ca0a61bca0a55e4d575af5a93bdf4905a3702fadedf451ea584791d233ade90965d608bac57304");

		expect(result).toBeInstanceOf(WalletData);
		expect(result.address()).toBe("aec30330deaecdd7503195a0d730256faef87027022b1bdda7ca0a61bca0a55e4d575af5a93bdf4905a3702fadedf451ea584791d233ade90965d608bac57304");
