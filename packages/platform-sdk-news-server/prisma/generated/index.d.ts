...
export namespace Prisma {
  ...
  */
  ...
  export type CoinGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof Coin ?Coin [P]
  : 
          P extends 'teams'
  ...
  export interface CoinDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Coin'> extends True ? CheckSelect<T, Prisma__CoinClient<Coin>, Prisma__CoinClient<CoinGetPayload<T>>> : CheckSelect<T, Prisma__CoinClient<Coin | null >, Prisma__CoinClient<CoinGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Coin'> extends True ? CheckSelect<T, Prisma__CoinClient<Coin>, Prisma__CoinClient<CoinGetPayload<T>>> : CheckSelect<T, Prisma__CoinClient<Coin | null >, Prisma__CoinClient<CoinGetPayload<T> | null >>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, CoinGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCoinGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export type TeamGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        P extends 'signals'
        ? Array < SignalGetPayload<S['include'][P]>>  : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
        ...
        P extends 'signals'
        ? Array < SignalGetPayload<S['select'][P]>>  : never
  } 
    : Team
  : Team
  ...
  export class Prisma__TeamClient<T> implements PrismaPromise<T> {
    ...
    signals<T extends SignalFindManyArgs = {}>(args?: Subset<T, SignalFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Signal>>, PrismaPromise<Array<SignalGetPayload<T>>>>;
  ...
  export type SignalGetPayload<
    S extends boolean | null | undefined | SignalArgs,
    U = keyof S
      > = S extends true
        ? Signal
    : S extends undefined
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof Signal ?Signal [P]
  : 
          P extends 'team'
  ...
  export interface SignalDelegate<GlobalRejectSettings> {
     ...
     * })
    **/
    findUnique<T extends SignalFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, SignalFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Signal'> extends True ? CheckSelect<T, Prisma__SignalClient<Signal>, Prisma__SignalClient<SignalGetPayload<T>>> : CheckSelect<T, Prisma__SignalClient<Signal | null >, Prisma__SignalClient<SignalGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends SignalFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, SignalFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Signal'> extends True ? CheckSelect<T, Prisma__SignalClient<Signal>, Prisma__SignalClient<SignalGetPayload<T>>> : CheckSelect<T, Prisma__SignalClient<Signal | null >, Prisma__SignalClient<SignalGetPayload<T> | null >>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends SignalAggregateArgs>(args: Subset<T, SignalAggregateArgs>): PrismaPromise<GetSignalAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, SignalGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSignalGroupByPayload<T> : Promise<InputErrors>
  }
