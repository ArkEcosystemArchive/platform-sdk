...
describe("#validate", () => {
	describe("#delegate", () => {
		...
		it("should throw if an invalid [delegate.payout.frequency.type] is used", () => {
			...
			expect(() => subject.validate()).toThrow('\"delegate.payout.frequency.type\" must be one of [day, week, month, quarter, year]');
		});
		...
		it("should throw if an invalid [delegate.payout.frequency.value] is used", () => {
			...
			expect(() => subject.validate()).toThrow('\"delegate.payout.frequency.value\" must be less than or equal to 365');
		});
		...
		it("should throw if an invalid [delegate.payout.distribution.min] is used", () => {
			...
			expect(() => subject.validate()).toThrow('\"delegate.payout.distribution.min\" must be less than or equal to 100');
		});
		...
		it("should throw if an invalid [delegate.payout.distribution.max] is used", () => {
			...
			expect(() => subject.validate()).toThrow('\"delegate.payout.distribution.max\" must be less than or equal to 100');
		});
		...
		it("should throw if an invalid [delegate.payout.percentage.min] is used", () => {
			...
			expect(() => subject.validate()).toThrow('\"delegate.payout.percentage.min\" must be less than or equal to 100');
		});
		...
		it("should throw if an invalid [delegate.payout.percentage.max] is used", () => {
			...
			expect(() => subject.validate()).toThrow('\"delegate.payout.percentage.max\" must be less than or equal to 100');
		});
	});
	...
	describe("#sourceControl", () => {
		it("should throw if an invalid URL is used for [bitbucket]", () => {
			...
			expect(() => subject.validate()).toThrow('\"sourceControl[0].value\" does not match any of the allowed types');
		});
