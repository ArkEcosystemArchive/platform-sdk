...
var _Censor_instances, _Censor_removeBadWords, _Censor_removeSpam;
Object.defineProperty(exports, "__esModule", { value: true });
exports.Censor = void 0;
const bad_words_1 = __importDefault(require("bad-words"));
const censorify_it_1 = __importDefault(require("censorify-it"));
/**
...
class Censor {
	constructor() {
		 ...
		 * @memberof Censor
		 */
		Object.defineProperty(this, "shortUrls", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: [
	...
	process(value) {
		if (value) {
			value = __classPrivateFieldGet(this, _Censor_instances, "m", _Censor_removeSpam).call(this, value);
			value = __classPrivateFieldGet(this, _Censor_instances, "m", _Censor_removeBadWords).call(this, value);
		}
		return value;
	}
}
exports.Censor = Censor;
(_Censor_instances = new WeakSet()),
	(_Censor_removeBadWords = function _Censor_removeBadWords(value) {
		const badwords = new bad_words_1.default();
	...
	(_Censor_removeSpam = function _Censor_removeSpam(value) {
		return new censorify_it_1.default().process(value);
	});
