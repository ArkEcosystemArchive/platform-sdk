...
exports.transferFundsWithTRX = void 0;
const helpers_1 = require("../../helpers");
const transferFundsWithTRX = async (env) => {
	const logger = helpers_1.useLogger();
	// Create profile
	const profile = await helpers_1.createProfile(env, "tron-profile", "my-password");
	// Restore it and sync
	await env.profiles().restore(profile, "my-password");
	await profile.sync();
	// Create read-write wallet 1
	const mnemonic1 = "cabin fold parrot grunt tide exact spoon regular wait mercy very fame";
	...
	const address2 = "TXaMbkVYxQySwumStDujGt5b9nkJwKDsSA";
...
exports.transferFundsWithTRX = transferFundsWithTRX;
