...
exports.transferFundsWithADA = void 0;
const helpers_1 = require("../../helpers");
const transferFundsWithADA = async (env) => {
	const logger = helpers_1.useLogger();
	// Create profile
	const profile = await helpers_1.createProfile(env, "ada-profile", "my-password");
	// Restore it and sync
...
exports.transferFundsWithADA = transferFundsWithADA;
