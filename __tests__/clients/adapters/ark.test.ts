...
describe("Ark", function () {
	describe("#getBlock", () => {
		it("should succeed", async () => {
			nock("https://dexplorer.ark.io/api")
				...
				.reply(200, require(`${__dirname}/__fixtures__/ark/block.json`));
	...
	describe("#getBlocks", () => {
		it("should succeed", async () => {
			nock("https://dexplorer.ark.io/api")
				.get("/blocks")
				.reply(200, require(`${__dirname}/__fixtures__/ark/blocks.json`));
	...
	describe("#getTransaction", () => {
		it("should succeed", async () => {
			nock("https://dexplorer.ark.io/api")
				...
				.reply(200, require(`${__dirname}/__fixtures__/ark/transaction.json`));
	...
	describe("#getTransactions", () => {
		it("should succeed", async () => {
			nock("https://dexplorer.ark.io/api")
				.get("/transactions")
				.reply(200, require(`${__dirname}/__fixtures__/ark/transactions.json`));
	...
	describe("#getWallet", () => {
		it("should succeed", async () => {
			nock("https://dexplorer.ark.io/api")
				...
				.reply(200, require(`${__dirname}/__fixtures__/ark/wallet.json`));
	...
	describe("#getWallets", () => {
		it("should succeed", async () => {
			nock("https://dexplorer.ark.io/api")
				.get("/wallets")
				.reply(200, require(`${__dirname}/__fixtures__/ark/wallets.json`));
