...
import { Atom } from "../../../src/coins/atom/client";
import { Block, Delegate, Peer, Transaction, Wallet } from "../../../src/coins/atom/dto";

let subject: Atom;

beforeEach(() => (subject = new Atom("https://api.cosmos.network")));
